...
<head>
    ...
    <title>infoStation Welcome</title>
                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%"
                                   style="margin:0 auto;">
                                <tr>
                                    <td style="font-size: 30px; text-align:center; color: #6a56a5">
                                        <br>
                                        infoStation
                                        <br>
                                        <br>
                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                                <tr>
                                                    <td style="color:white;">
                                                        <br>
                                                        To the awesomest place on earth! We're sure you will feel right
                                                        at home with infoStation.
                                                        <br>
                                                        <br>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div><!--[if mso]>
                                            ...
                                            <![endif]-->
                                            <a href="infostation/"
                                               style="background-color:#6a56a5;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">infoStation</a>
                                            <!--[if mso]>
                                            </center>
                                            </v:roundrect>
                                            <![endif]--></div>
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td>
                                        <img src="https://www.filepicker.io/api/file/tjUsYjIHSDCkrrniLuev" width="145"
                                             height="89" alt="meter image">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                                <tr>
                                                    <td style="color:#933f24;">
                                                        <br>
                                                        We are coming soon with new pages. Stay on hold.
                                                        <br><br>
                                                    </td>
                                                </tr>
                                            </table>
