                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li class="@yield('content-active')">
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="ti-server"></i><span>Content</span></a>
                            <ul class="collapse">
                        ...
                        <li class="@yield('comment-active')"><a href="{{route('comments-view')}}"><i
                                    class="ti-layers-alt"></i> <span>comments</span></a></li>
                        <li class="@yield('contact-active')"><a href="{{route('admin-contact')}}"><i class="ti-comment-alt"></i> <span>contact message</span></a>
                        </li>
                        <li class="@yield('users-active')"><a href="{{route('users')}}"><i class="ti-user"></i> <span>users</span></a>
                        </li>
                        <li class="@yield('bulletin-active')"><a href="{{route('bulletin')}}"><i class="fa fa-bell-o"></i> <span>bulletin members</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
